...
public final class Preconditions {
  ...
  private static String lenientToString(Object o) {
    ...
    try {
      ...
      String objectToString =
          o.getClass()
           .getName() + '@' + Integer.toHexString(System.identityHashCode(o));
      ...
      return "<" + objectToString + " threw " + e.getClass()
                                                 .getName() + ">";
    }
  }
  ...
  public static void checkState(
    ...
    if (!expression) {
      throw new IllegalStateException(lenientFormat(
          errorMessageTemplate,
          errorMessageArgs
      ));
    }
  ...
  public static <T> T checkNotNull(
    ...
    if (reference == null) {
      throw new NullPointerException(lenientFormat(
          errorMessageTemplate,
          errorMessageArgs
      ));
    }
  ...
  public static int checkElementIndex(
    ...
    if (index < 0 || index >= size) {
      throw new IndexOutOfBoundsException(badElementIndex(
          index,
          size,
          desc
      ));
  ...
  private static String badPositionIndex(
      int index,
      int size,
      String desc
  ) {
  ...
  private static String badPositionIndexes(
      int start,
      int end,
      int size
  ) {
