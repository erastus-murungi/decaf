...
public class DecafScanner {
  ...
  private DecafScannerException getContextualException(
      TokenPosition tokenPosition,
      String errMessage
  ) {
    return decafExceptionProcessor.getContextualDecafScannerException(
        prevToken,
        getCurrentChar(),
        tokenPosition,
        errMessage
