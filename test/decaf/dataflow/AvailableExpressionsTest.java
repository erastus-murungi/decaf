...
public class AvailableExpressionsTest extends TestCase {
    private final IrRegister a = new IrRegister("a", Type.Int);
    private final IrRegister b = new IrRegister("b", Type.Int);
    private final IrRegister c = new IrRegister("c", Type.Int);
    private final IrRegister d = new IrRegister("d", Type.Int);
